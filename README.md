...
An application that utilizes the Google Book API to allow users to browse and explore books and a summary of the book's context. It also allows users to create their own library or collection of books by creating an account.
